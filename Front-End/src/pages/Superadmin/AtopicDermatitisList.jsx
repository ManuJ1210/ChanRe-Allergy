...
export default function SuperadminAtopicDermatitisList() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white rounded-xl shadow">
      <h2 className="text-2xl font-bold mb-4 text-blue-800">Atopic Dermatitis Records</h2>
      {loading ? (
        <div>Loading...</div>
      ) : error ? (
              ...
              <tr key={rec._id} className="border-b hover:bg-blue-50">
                ...
                <td className="px-4 py-2">
                  <button
                    ...
                    onClick={() => navigate(`/CenterAdmin/patients/FollowUp/ViewAtopicDermatitis/${rec._id}`)}
                  >
                    View Details
                  </button>
                </td>
