...
const AddSuperadminReceptionist = () => {
  ...
  const { loading, error, success, message } = useSelector((state) => state.superAdminReceptionists);
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await dispatch(addSuperAdminReceptionist(formData));
    
    if (addSuperAdminReceptionist.fulfilled.match(result)) {
      setTimeout(() => {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800 mb-2">
            Add New Superadmin Receptionist
          </h1>
          <p className="text-slate-600">
            Register a new receptionist for superadmin management
          </p>
        </div>
...
export default AddSuperadminReceptionist; 