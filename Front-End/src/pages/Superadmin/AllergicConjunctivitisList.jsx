  ...
  useEffect(() => {
    const fetchRecords = async () => {
      ...
      try {
        ...
        console.log('🔍 Fetching allergic conjunctivitis records for patientId:', patientId);
        const res = await API.get(`/allergic-conjunctivitis?patientId=${patientId}`, { headers: { Authorization: `Bearer ${token}` } });
        console.log('📊 Allergic conjunctivitis API response:', res.data);
        setRecords(res.data);
      } catch (err) {
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-center">
                          <button
                            ...
                            onClick={() => navigate(`/Superadmin/ViewAllergicConjunctivitis/${patientId}`)}
                          >
