    ...
    <div className="bg-white py-16 px-4 sm:px-8 md:px-20 lg:px-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">How to Apply?</h3>
          ...
          <div className="bg-green-50 border border-green-400 rounded-xl shadow p-4 mb-4 space-y-3">
            <div className="flex items-center space-x-3">
              <FaWhatsapp className="text-green-600 text-xl" />
              <span className="text-gray-800 font-medium">+91 9611768775</span>
            </div>
            <div className="flex items-center space-x-3">
              <FaEnvelope className="text-blue-600 text-xl" />
              <span className="text-gray-800 font-medium">corporaterelation@chanrerier.com</span>
            </div>
          </div>
