...
const ViewProfile = () => {
  ...
  return (
    <div className="p-4 sm:p-8 bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen">
      {/* Header */}
      <div className="relative rounded-2xl p-8 flex flex-col md:flex-row items-center md:items-end justify-between mb-10 shadow-xl bg-gradient-to-r from-blue-200 to-blue-400 border border-blue-100">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h2 className="text-4xl font-bold text-blue-700 mb-1">{patient.name}</h2>
            <div className="flex flex-wrap gap-4 text-slate-500 text-base">
