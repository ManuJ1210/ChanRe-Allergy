...
import { fetchReceptionistAtopicDermatitis, resetReceptionistState } from '../../../../features/receptionist/receptionistThunks';
import { 
  ArrowLeft, 
  AlertCircle,
  Activity,
...
const ViewAtopicDermatitis = () => {
  ...
  const { atopicDermatitis, loading, error } = useSelector(state => state.receptionist);
