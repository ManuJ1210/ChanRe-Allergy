            ...
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-slate-500 text-sm">
                  ...
                  <br />
                  As a receptionist, your role is to handle billing for test requests and mark payments.
                  <br />
                  <span className="text-blue-600 font-medium">Workflow:</span> Pending → Generate Bill → Mark Paid → Ready for Lab Processing
                </p>
              </div>
            )}
          </div>
                ...
                <div className="p-4 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      After generating the bill, the test request will be ready for payment. Once marked as paid, it will proceed to lab processing.
                    </p>
                  </div>
                </div>
